...
const frame = ({
  ...
  <text x="1168" y="166" text-anchor="end" font-family="Helvetica, Arial, sans-serif" font-size="19" font-weight="bold" fill="${tagFill}" letter-spacing="4.5">${tag}</text>
</svg>
`;
...
const DARK = {
	...
	dot: BRAND_LIGHT,
	rule: BRAND_LIGHT,
	markAccent: BRAND_LIGHT,
};

const variants = {
	"cl-banner": { ...DARK, tag: "CHANGELOG" },
	"su-banner": { ...DARK, tag: "STATUS UPDATE" },
	"su-banner-alt": { ...DARK, tag: "STATUS UPDATE", tagFill: "#a99fb8" },
};
